...
s1.async=true;
s1.src='https://embed.tawk.to/62c2b2bfb0d10b6f3e7aaad5/1g748kfc4';
s1.charset='UTF-8';
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-139369565-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-139369565-1');
</script>
<!-- Google Analytics -->
  <script type="text/javascript">
...
/></noscript>
  ...
  <link rel="shortcut icon" href="images\fox-logo-dummy.png">
  
  
  <title>Pixel Fox</title>
  <style>
...
">
  <div class="pixel_body_container">
    <div class="navbar nav nav-tabs" role="tablist" id="collapse_navbar">
     
      <div class="navigation_links ">
        <div class="logo_div">
          <img class="fox_logo" src="images\fox-logo-dummy.png" alt="Error Loading Image">
          <h5 class="image_text_nav">Pixel Fox</h5>
        </div>
        <a class="nav-link nav_tab_switches active" href="#pixel_manager"  data-bs-toggle="tab" role="tab" aria-controls="pixel_manager" aria-selected="true"><i class="bi bi-code-slash fox_icon"></i>Pixel Manager</a>
        <a class="nav-link nav_tab_switches" onclick="getCatalog()" href="#catalogue_manager" data-bs-toggle="tab" role="tab" aria-controls="catalogue_manager" aria-selected="false"><i class="bi bi-collection-fill fox_icon"></i>Catalog Manager</a>
        <a class="nav-link nav_tab_switches" href="#interest_finder" data-bs-toggle="tab" role="tab" aria-controls="interest_finder" aria-selected="false"><i class="bi bi-search fox_icon"></i>Interest Finder</a>
      </div>
      <div class="bottom_navigation_links ">
        <a class="nav-link nav_tab_switches" id="paymentMod" href="#payment_modal" data-bs-toggle="tab" role="tab" aria-controls="payment_modal" aria-selected="false">
          <i class="bi bi-currency-exchange fox_icon"></i>
          Payment
        </a>
        <a class="nav-link nav_tab_switches" href="#faq_modal" data-bs-toggle="tab" role="tab" aria-controls="faq_modal" aria-selected="false">
          <i class="bi bi-question-circle-fill fox_icon"></i>FAQ's
        </a>
        <a class="nav-link nav_tab_switches" href="#contact_modal" data-bs-toggle="tab" role="tab" aria-controls="contact_modal" aria_selected="false">
          <i class="bi bi-telephone-fill fox_icon"></i>Contact Us
        </a> 
        <a class="color_black" target="_blank" href="https://apps.shopify.com/pixels-fox-conversion-api#modal-show=ReviewListingModal&st_campaign=rate-[…]=contextual&utm_medium=shopify&utm_source=admin">
          <i class="bi bi-star-fill fox_icon"></i>Write A review
        </a>
        <a class="nav-link nav_link_button" target="_blank" href="https://calendly.com/expert-chat/pixel-fox-1-on-1-live-support-call?month=2022-07">
          <span class="app_button"> Book An Appointment</span>
        </a>
    ...
    <div class="tab_body tab-content" id="myTabContent">
      <!--==================Interest Finder Modal====================-->
      <div class="tab-pane fade" id="interest_finder" role="tabpanel" aria-labelledby="interest_finder">
        <div class="container" style="background: #f1f1f1">
          <div class="container search_box_div ctc_2">
            <input class="search_box_pixel " id="search" name="search" type="text" placeholder="Search">
            <i class="bi bi-search fox_icon search_icon"></i>
            <button id="saveCopy" class="search_pixel_button clip_button ctc_2 btn btn-save">Copy to clipboard</button>
            <button class="search_pixel_button ctc_2 btn" id="download-button">Export CSV</button>
          </div>
          <div class="container yt_button py-2">
            <a href="https://www.youtube.com/watch?v=lC4V16uXg0E&feature=youtu.be" target="_blank"><button class="btn btn-primary"><i class="bi bi-camera-video-fill"></i> Instructional video</button></a>
          </div>
          <div class="card" style="width: 80%; margin: auto;">
            <div class="card-body">
              ...
              <div class="container container_plus">
                <button type="button" class="btn btn-secondary tag" data-type="adinterestsuggestion&interest_list=['type']">Interest suggestions</button>
                <button type="button" id="interest" class="btn btn-secondary tag" data-type="adinterest">Interest</button>
                <button type="button" class="btn btn-secondary tag" data-type="adworkposition">Job Titles</button>
                <button type="button" class="btn btn-secondary tag" data-type="adworkemployer">Work Employee</button>
                <button type="button" class="btn btn-secondary tag" data-type="adeducationmajor">Education Majors</button>
                <!-- <button type="button" class="btn btn-secondary tag" data-type="adTargetingCategory&class=behaviors">Behaviour</button> -->
              </div>
          ...
          <table id="tableInterset" class="table new_code_table">
      ...
      <!-- =========Create Pixel Modal========== -->
      <div class="tab-pane fade show active" id="pixel_manager" role="tabpanel" aria-labelledby="pixel_manager">
        <div class="container search_box_div">
          <input class="search_box_pixel" type="text" placeholder="Search">
          <i class="bi bi-search fox_icon search_icon"></i>
          <button class="search_pixel_button btn" id="createbtn" data-bs-toggle="modal" data-bs-target="#create_pixel_modal">Create Pixel</button>
        </div>
        <div class="container yt_button">
          <a href="https://www.youtube.com/watch?v=LS_WXzNfzLg&feature=youtu.be" target="_blank"><button class="btn btn-primary"><i class="bi bi-camera-video-fill"></i>Instructional Video</button></a>
        </div>

        <div class="table_div_pixel">
          <table class="table table-hover table-fixed list">
            <thead>
              <tr>
                <th>Pixel Id</th>
                <th>Type</th>
                <th>Server-side API</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody id="tablepixel">
              ...
              <tr id="{{$pixel->id}}">
                ...
                <td>
                  ...
                  <i class="bi bi-check-circle-fill icon_check"></i>
                  @else
                  <i class="bi bi-x-circle-fill icon_cross"></i>
                  @endif

                </td>
                <td class="d-flex">
                  <a id="element_to_click">
                    <i value="{{$pixel->id}}" class="bi bi-pencil-square action_icon editbtn"></i>
                  </a>
                  <a href="#" class="delpixel" data-id="{{$pixel->id}}">
                    <i class="bi bi-trash action_icon "></i>
                  </a>

                  <label class="switch">
                    @if($pixel->status)

                    <input type="checkbox" value="{{$pixel->id}}" id="status_pixel" checked>

                    @else

                    <input type="checkbox" value="{{$pixel->id}}" id="status_pixel">
        ...
        <!-- <<<<<<<<<<Create Pixel Modal>>>>>>>>>>> -->
        <form class="pixel-edit-form" name="myForm" id="myFormpixel" method="post">
          <div class="modal fade" id="create_pixel_modal" tabindex="-1" aria-labelledby="cpixelmodal" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Create New Pixels</h5>
                  <i class="bi bi-x-circle" data-bs-dismiss="modal" aria-label="close"></i>
                </div>
                <div class="modal-body">

                  <div class="mb-3 search_div_create_pixel">
                    <h6>Pixel Id</h6>
                    <input type="text" id="pixels_id" class="search_box_pixel search_box_modal" value="" placeholder="Enter Your Facebook Pixels" name="pixel_id_input">
                    <input type="hidden" id="updatedId">
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" onclick="master()" checked="checked" type="radio" value="master" name="flexRadioDefault" id="flexRadioDefault1">
                    <label class="form-check-label" for="flexRadioDefault1"> Master Pixel
                      <div class="tooltip_pixel"><i class="bi bi-question-circle-fill fox_icon"></i>
                        <span class="tooltiptext">Will fire for entire store including all products.</span>
                      </div>
                    </label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" onclick="collection()" value="collection" name="flexRadioDefault" id="flexRadioDefault2">
                    <label class="form-check-label" for="flexRadioDefault2">Collection Pixel
                      <div class="tooltip_pixel"><i class="bi bi-question-circle-fill fox_icon"></i>
                        <span class="tooltiptext"> Assigning one or more collections to a pixel to keep firing for only those products which exists in the assigned collections.</span>
                      </div>
                    </label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" onclick="niche()" type="radio" value="niche" name="flexRadioDefault" id="flexRadioDefault3">
                    <label class="form-check-label" for="flexRadioDefault3">Niche Tag Pixels
                      <div class="tooltip_pixel"><i class="bi bi-question-circle-fill fox_icon"></i>
                        <span class="tooltiptext">Assign a pixel to a specific tag and use that tag into those products where you want to fire the pixel.</span>
                      </div>
                    </label>
                  </div>
                  <div class="py-2" role="alert" id="embbed_div">

                    @php
                    $shop_name=Auth::user()->name;
                    @endphp
                    <span>Please enable the pixels fox from theme editor under <a href="https://{{$shop_name}}/admin/themes/current/editor?context=apps&
        template=product&activateAppId=467f8cf1-28cf-47c4-b02a-faba85c7400d/app-embed" style="font-weight: bold;" target="_blank">App embeds </a> section</span>
                  </div>
                  <div class="alert alert-danger" role="alert" id="payment_div">
                    <i class="bi bi-exclamation-circle-fill"></i>
                    <span onclick="paymentModel()">Conversion api won’t work until you <a href="#payment_modal" style="font-weight: bold;">Upgrade</a> your plan, but enjoy 1 pixel as a gift for 7 days only.</span>
                  </div>

                  <div id="pixel_search_box">

                  </div>



                  <div id="collectionRow" style="margin-top: 10px;">
                    <select class="multiple_row" name="collections[]" id="collectionSelector" multiple style="margin-top:5px;width:100%">
                  ...
                  <div id="alert_modal_ios" class="alert_modal">
                    <label class="alert_label">
                      <input id="ios_checkbox" type="checkbox" onclick="ios_checkBox()">Conversion API (solution for apple devices)
                    </label>
                    <div class="alert_modal_content"></div>
                  </div>

                </div>
        </form>
        <div class="modal-footer">
          <button type="button" class="btn close_cpixel_modal" data-bs-dismiss="modal">Close</button>
          <button type="button" onclick="myFunction()" value="insert" id="save1" class="btn save_cpixel_modal">Save changes</button>
          <button type="button" value="update" onclick="myFunction()" id="update" class="btn save_cpixel_modal">Update</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="tab-pane fade" id="catalogue_manager" role="tabpanel" aria-labelledby="catalogue_manager">
    <div class="container search_box_div">
      <input class="search_box_pixel" type="text" placeholder="Search">
      <i class="bi bi-search fox_icon search_icon"></i>
      <button class="search_pixel_button btn" data-bs-toggle="modal" data-bs-target="#create_catalogue_modal">Create Catalog</button>
    </div>
    <div class="container yt_button">
      <a href="https://www.youtube.com/watch?v=24Eu4plibtU&feature=youtu.be" target="_blank"><button class="btn btn-primary"><i class="bi bi-camera-video-fill"></i>Instructional Video</button></a>
    </div>
    <div class="table_div_pixel">
      <table class="table table-hover table-fixed a_heading2">
        ...
        <tbody id="tableData1">
          ...
          if($type == "all")
          {
          $url = "{$domain}/{$shop}/pages/pixels-fox-feed?collection={$collection}&variant={$variant}&category={$category}";
          }
          else
          {
          $url = "{$domain}/{$shop}/pages/pixels-fox-feed?collection={$collection}&variant={$variant}&category={$category}&type={$type}";
          }

          @endphp
          <tr>
            <td scope="row">{{ $data->feedName }} </td>
            <td>{{ $collection }}</td>
            <td>{{ $variant }}</td>
            <td><span class="generate"  data-url="{{ $url }}">Click To Copy URL</span></td>
            <td class="d-flex">
              <a class="delc" data-id="{{ $id }}">
                <i class="bi bi-trash action_icon"></i>
              </a>
            </td>
    ...
    <form class="pixel-edit-form" name="myForm" id="myForm" method="post">
      <div class="modal fade" id="create_catalogue_modal" id="exampleModalcat" tabindex="-1" aria-labelledby="ccataloguemodal" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Create New Catatlog</h5>
              <i class="bi bi-x-circle" data-bs-dismiss="modal" aria-label="close"></i>
            </div>
            <div class="modal-body ">
              <form class="pixel-edit-form" name="myForm" id="myForm" method="post">
                <input type="text" class="search_box_pixel search_box_modal modal_field_2" placeholder="Feeds Name" id="feedName" name="search">
                <select id="collection1" name="collection1" class="search_box_pixel search_box_modal modal_field_2" id="">
                  <option value="0" selected="">Select Pixels</option>
                  <option value="all" selected="">All</option>
                  @foreach($collections as $collection)
                  <option value="{{ $collection['handle'] }}" data-id="{{ $collection['id'] }}" data-type="{{ $collection['type'] }}">{{ $collection['title'] }}</option>
                  @endforeach
                </select>

                <select class="search_box_pixel search_box_modal modal_field_2" id="category">
                  <option value="0">Facebook Products Categories</option>
                  <option>Collection 1</option>
                  <option>Collection 2</option>
                  <option>Collection 2</option>
                </select>
                </br>
                <div class="custom_type" style="display:none">
                  <input type="text" name="custom_type" class="search_box_pixel search_box_modal modal_field_2" placeholder="Type" id="custom_type" name="custom_type">
                </div>
                <div>
                  <label class="switch">
                    <input type="checkbox" class="variants" id="variants">
                    <span class="slider"></span>
                  </label>
    ...
    <div class="modal-footer">
      <button type="button" class="btn close_cpixel_modal" data-bs-dismiss="modal">Close</button>
      <button type="button" class="btn save_cpixel_modal" id="save_feed">Save changes</button>
    </div>
  </div>
  </div>
  </div>
  ...
  <!-- =============Payement Modal============= -->
  <div class="tab-pane fade" id="payment_modal" role="tabpanel" aria-labelledby="payment_modal">
    <div class="card_wrapper">
      <div class="card card_custom_class text-center plan_1" id="plan_1">
        <div class="card-body">
          <div class="card-header">
            <h3 class="card-title card_title_payment_modal">Basic</h3>
          </div>
          <div class="price-circle-border">
            <div class="price_circle">
              <p class="payment_modal_price">$6.99</p>
              <p class="price_text_payment_modal">per month</p>
            </div>
          </div>
          <ul class="benefits_payment_modal">
            <li>2 Pixel Id's</li>
            <li>2 Conversion APIs</li>
            <li>1000 Product Catalog</li>
            <li>Instant Feed Update</li>
            <li>Conversion Api Supported</li>
            <li>Email Support</li>
            <li><i class="bi bi-x-circle fox_icon"></i>Server Side Events</li>
          </ul>
          <button class="plan_selection_button" id="btnselect1"><a id="selctiobtn" href="{{ route('billing', ['plan' =>1]) }}"> Select Plan </a></button>
        </div>
      </div>
      <div class="card card_custom_class text-center plan_2 " id="plan_2">
        <div class="card-body">
          <div class="card-header">
            <h3 class="card-title card_title_payment_modal">Standard</h3>
          </div>
          <div class="price-circle-border">
            <div class="price_circle">
              <p class="payment_modal_price">$12.99</p>
              <p class="price_text_payment_modal">per month</p>
            </div>
          </div>
          <ul class="benefits_payment_modal">
            <li>5 Pixel Id's</li>
            <li>5 Conversion APIs</li>
            <li>5000 Product Catalog</li>
            <li>Instant Feed Update</li>
            <li>Server Side Events</li>
            <li>Conversion Api Supported</li>
            <li>Technical Live Support</li>
          </ul>
          <button class="plan_selection_button" id="btnselect2"><a id="selctiobtn" href="{{ route('billing', ['plan' =>2]) }}"> Select Plan</a></button>
        </div>
      </div>
      <div class="card card_custom_class text-center plan_3 " id="plan_3">
        <div class="card-body">
          <div class="card-header">
            <h3 class="card-title card_title_payment_modal">Premium</h3>
          </div>
          <div class="price-circle-border">
            <div class="price_circle">
              <p class="payment_modal_price">$29.99</p>
              <p class="price_text_payment_modal">per month</p>
            </div>
          </div>
          <ul class="benefits_payment_modal">
            <li>Unlimited FB Pixel Id's</li>
            <li>Unlimited Conversion APIs</li>
          ...
          <button class="plan_selection_button" id="btnselect3"><a id="selctiobtn" href="{{ route('billing', ['plan' =>3]) }}"> Select Plan</a></button>
        </div>
      </div>
    </div>
  </div>
  <!-- =========== Faq's Modal ============== -->
  <div class="tab-pane fade py-4" id="faq_modal" role="tabpanel" aria-labelledby="faq_modal">
    <div class="accordion accordion-flush accordion_div_faq" id="accordionFlushExample">
      <div class="accordion-item">
        ...
        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Pixels Fox is an all-in-one shopify app designed to help store owners easily install their facebook pixel, manage it and use powerful pixel features to optimize their facebook campaigns.</div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="flush-collapsethirteen" class="accordion-collapse collapse" aria-labelledby="flush-headingthirteen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Pixels Fox is for everyone who owns an online store, especially a Shopify store. It doesn’t matter if you are a newbie who had never heard about ‘pixel’ a few days ago or a veteran advertising, Pixels Fox app will help you install your pixel, manage it, and optimize it for more conversions in a few clicks. No coding required!
          </div>
        </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingTwo">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
            I’m a Beginner in Facebook Advertising.What Do I Have to Do ?
          </button>
        </h2>
        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">
            <div>
              You can get Pixels in your Facebook business manager, For Facebook Pixel You Need to Create a Business Manager.
            </div>
            Here is a Simple Guide for you.
            <div>
              <ol>
                <li>Make Sure Your Facebook Profile Login.</li>
                <li>Go to <a target="_blank" href="https://business.facebook.com/overview">business.facebook.com/overview.</a></li>
                <li>Click Create Account.
                  <div class="container">
                    <img src="{{asset('/faqs_image/img1.jpg')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li class="py-4"> Enter a name for your business, your name and work email address and click Next. <div class="container">
                    <img src="{{asset('/faqs_image/img2.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li>Enter your business details and click Submit.
                  <div class="container">
                    <img src="{{asset('/faqs_image/img3.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingThree">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                Create and Install a Facebook Pixel into Pixels Fox App
          </button>
        </h2>
        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">
            <ol>
              <li>Go to <a href="https://business.facebook.com/">Business Settings.</a></li>
              <li>Click Data Sources and Below Pixels.</li>
              <li>Click + Add.
                <div class="container py-4">
                  <img src="{{asset('/faqs_image/img4.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
              ...
              <li>Give Name To your Pixel ID.
                <div class="container py-4">
                  <img src="{{asset('/faqs_image/img5.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
              ...
              <li>Once You've Created, Now Open Your Selected Pixel in Events Manager.
                <div class="container py-4">
                  <img src="{{asset('/faqs_image/img6.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
              ...
              <li>Click Setting on your Selected Pixel, Copy your pixel ID and Conversion API Token
                <div class="container py-4">
                  <img src="{{asset('/faqs_image/img7.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <div class="container py-4">
                  <img src="{{asset('/faqs_image/img8.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
              ...
              <li class="py-2">Copy Your Facebook Pixel ID and Conversion API and Paste Into Pixels Fox App.
                <div class="container py-4">
                  <img src="{{asset('/faqs_image/img9.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingThree">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour">
                 How do I check if the Pixel app is working properly in my store?
          </button>
        </h2>
        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">If you would like to check, please use the Facebook pixel helper Chrome browser extension to check that events are firing correctly on your website.
            <div class="container py-4">
              <img src="{{asset('/faqs_image/img10.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingThree">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSix" aria-expanded="false" aria-controls="flush-collapseFive">
            Is shipping cost included when reporting the Purchase Value.?
             </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingSeven1">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSeven1" aria-expanded="false" aria-controls="flush-collapseSeven1">
              How can I add a Pixel to a Specific Collection?
        ...
        <div id="flush-collapseSeven1" class="accordion-collapse collapse" aria-labelledby="flush-headingSeven1" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">First you have to paste your id into the app then choose the pixel type , right now i'm clicking on collection pixel as you can see in the image below, it will show you the list of collections here select your desired collection and hit save changes.

            <div class="container py-4">
              <img src="{{asset('/faqs_image/img11.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingEight">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseEight" aria-expanded="false" aria-controls="flush-collapseEight">
              How to add TAG Pixel to products?
          </button>
        </h2>
        <div id="flush-collapseEight" class="accordion-collapse collapse" aria-labelledby="flush-headingEight" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">As usual, paste your Pixel and click on Niche TAG Pixel, Write your TAG name. Go to Product Menu choose your desired product and add Tag into the product tag section and save it.
            <div class="container py-4">
              <img src="{{asset('/faqs_image/image12.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingnone">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsenone" aria-expanded="false" aria-controls="flush-collapsenone">
              What About Facebook Product Feed Catalog Generation?
          </button>
        </h2>
        <div id="flush-collapsenone" class="accordion-collapse collapse" aria-labelledby="flush-headingnone" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">You can use Pixels Fox Facebook product feed generation that is compatible with Shopify. Fox product feed generated should send the Shopify product data to Facebook
          </div>
        </div>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingten">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseten" aria-expanded="false" aria-controls="flush-collapseten">
              Where and how do I upload my Fox product feed URL?
          </button>
        </h2>
        <div id="flush-collapseten" class="accordion-collapse collapse" aria-labelledby="flush-headingten" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Just add the feed to our app generated to your Facebook product catalog.
            <div>It's really simple to install actually - just a couple of steps:</div>
            <div>
              <ol>
                <li>Select or Create your Catalog in the the Catalog Manager
                  <div>
                    <ul>
                      <li>Go to DATA Sources</li>
                      <li>Click on Catalogs</li>
                      <li>Click on +ADD</li>
                      <li>Create a New Catalog</li>
                ...
                <li>
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img12.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li>After Creating Catalog you need to upload shopify product.Click on Data Sources</li>
                <li>Select 'Use bulk upload'
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img13.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li class="py-2">Paste Your Fox Product Feed URL ,don’t setup password
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img14.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li class="py-2">I choose Weekly schedule updates, but it's depend on your business
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img15.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li class="py-2">Make Sure select your shopify store Default Currency
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img16.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li class="py-2">It's in inprocessing to sync product into to your Facebook Catalog
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img17.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
                ...
                <li class="py-2">After Completed Upload you can see Your Products
                  <div class="container py-4">
                    <img src="{{asset('/faqs_image/img18.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingeleven">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseeleven" aria-expanded="false" aria-controls="flush-collapseeleven">
            How to enable Pixels Fox on Online Store 2.0?
          </button>
        </h2>
        <div id="flush-collapseeleven" class="accordion-collapse collapse" aria-labelledby="flush-headingeleven" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Click on App Embeds link it will redirect you to active theme editor, make sure Pixels Fox is Enabled.Hit Save button.
            Note: By Default it is Enabled and Saved, in some cases if it does not work then you can try manually.
            <div class="container py-4">
              <img src="{{asset('/faqs_image/img20.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
...
">
            ...
            <div class="container py-4">
              <img src="{{asset('/faqs_image/img19.png')}}" style="
  display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingfourteen">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefourteen" aria-expanded="false" aria-controls="flush-collapsefourteen">
            Can I Try Pixels Fox Before Buying?
          </button>
        </h2>
        <div id="flush-collapsefourteen" class="accordion-collapse collapse" aria-labelledby="flush-headingfourteen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Absolutely. We stand behind our app 100% and would love you to sign up for a free, in which you can use the powerful features offered by Pixels Fox without paying a dime. In the free-trial, we will provide you with both the resources and the guidance you need to get the most out of Pixels Fox.
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingsixteen">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsesixteen" aria-expanded="false" aria-controls="flush-collapsesixteen">
            Do I need to know about coding to use Pixels Fox?
          </button>
        </h2>
        <div id="flush-collapsesixteen" class="accordion-collapse collapse" aria-labelledby="flush-headingsixteen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Absolutely not. Pixels Fox is for everyone and we put a lot of focus on making it as user-friendly as possible. With Pixels Fox, you can easily integrate your facebook pixel with your store, assign a pixel for pixel backup and build Ecommerce Manager Product Feed in a few clicks, without a single line of coding..
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingfifteen">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsefifteen" aria-expanded="false" aria-controls="flush-collapsefifteen">
            What’s included when I start my free Pixels Fox today? </button>
        </h2>
        <div id="flush-collapsefifteen" class="accordion-collapse collapse" aria-labelledby="flush-headingfifteen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">In your Pixels Fox free, you will get access to:
Install 1 Pixel as a gift but for conversion api you need to upgrade your plan 
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingseventeen">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseseventeen" aria-expanded="false" aria-controls="flush-collapseseventeen">
            Why is pixel fox better than similar shopify apps?
          </button>
        </h2>
        <div id="flush-collapseseventeen" class="accordion-collapse collapse" aria-labelledby="flush-headingseventeen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">We will be honestly. There are other apps that you can use for installing your facebook pixel but there are Four things which make installing Pixels Fox the best choice:
            <ol>
              <li>Safe and secure pixels: Your Facebook Data is always backed up - even if your ad account gets blocked by Facebook</li>
              <li> Effortlessly integrate & manage an unlimited number of Facebook pixels. That includes your master pixel, multiple backup pixels, multiple niche pixels & track data across all.</li>
              <li>With no coding or technical knowledge involved. The app will install the pixel code exactly on your store, the more pixel events and data are collected, the better optimization for more conversions.</li>
              <li> Overcome limitations like ad-blockers or privacy settings due to Apple's iOS 14 update, the events are sent directly to Facebook’s servers. It doesn’t fully replace the traditional browser events but will work as a backup solution when your Facebook Pixel doesn’t fire on a visitor’s brow</li>
            </ol>
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingeighteen">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseeighteen" aria-expanded="false" aria-controls="flush-collapseeighteen">
            Is Pixels Fox easy to install?
          </button>
        </h2>
        <div id="flush-collapseeighteen" class="accordion-collapse collapse" aria-labelledby="flush-headingeeighteen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Ofcourse! With Pixels Fox, you can easily install your pixel in your shopify store in a few clicks without any coding.
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingnonteen">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsenonteen" aria-expanded="false" aria-controls="flush-collapsenonteen">
            What kind of results should I expect from using Pixels Fox?
          </button>
        </h2>
        <div id="flush-collapsenonteen" class="accordion-collapse collapse" aria-labelledby="flush-headingenonteen" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">For any tool to work, you need to know how to use it. If you use Pixels Fox the way we want you to use it, you should be able to see a significant increase in your conversions, reduction in your ad spend and a lot more free time!
      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="flush-headingtwenty">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapsetwenty" aria-expanded="false" aria-controls="flush-collapsetwenty">
            How do I cancel app charges for Pixels Fox?
          </button>
        </h2>
        <div id="flush-collapsetwenty" class="accordion-collapse collapse" aria-labelledby="flush-headingetwenty" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">App charges that appear on your Shopify invoice are canceled by uninstalling the app from your store.
  ...
  <!-- ==============Contact Us============ -->
  <div class="tab-pane fade" id="contact_modal" role="tabpanel" aria-labelledby="contact_modal">
    <div class="container">
      <div class="contact_form">
        <div class="card-body_2 help-support">
          <form id="conatct_form">
            ...
            <div class="form-group">
              <label>Subject</label>
              <input id="subject" type="text" class="form-control" placeholder="example...">
            </div>
            <div class="form-group">
              <label>Message</label>
            ...
            <div class="form-group">
              <a href="#" class="send_button_pixel_contact">Send</a>
            </div>
          </form>
          <div class="container more_help" style="text-align: center !important;">
            <h4>Need More Help..?</h4>
            <p>Get in Touch:</p>
            <div class="row row_contact_icon_box">
              <div class="col-md-6 icon_contact_box">
                <div class="box">
                  <a href="https://www.facebook.com/pixelfoxshopifyapp" class="contact-us-btn" target="_blank" style=" color: black; text-decoration:none">
                    <i class="bi bi-facebook box_logo_end fox_icon"></i>
                    <h4>FaceBook</h4>
  ...
  <script src="js/script_fox.js"></script>

  <link href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.min.css" rel="stylesheet" />
  <script src="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.jquery.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/izitoast/1.4.0/js/iziToast.min.js" integrity="sha512-Zq9o+E00xhhR/7vJ49mxFNJ0KQw1E1TMWkPTxrWcnpfEFDEXgUiwJHIKit93EW/XxE31HSI5GEOW06G6BF1AtA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  <!--<link href="https://cdnjs.cloudflare.com/ajax/libs/slim-select/1.27.0/slimselect.css" rel="stylesheet" />-->
  ...
  <script>
     ...
     $(".nav_tab_switches").click(function() {
           // remove the active class from all elements with active class

        $('.active').removeClass('active')
        // add active class to clicked element
        console.log()
        let nav_attr = $(this).attr('aria-controls')
        let all_tabs = $('#myTabContent .tab-pane')
        for(val of all_tabs){
          if($(val).attr('aria-labelledby') == nav_attr){
            $(val).addClass('active')
            break;
          }
        }
      ...
      $("#collectionSelector").chosen();
      $("#collectionRow").hide();
      document.getElementById("ios_checkbox").disabled = true;
      var plan_id = "{{$plan_id}}";
      var shopify_freemium = "{{$shopify_freemium}}";
     
      if (plan_id) {
        if (plan_id == 1) {
          $("#plan_1").addClass("purchased");
        }
        if (plan_id == 2) {
          $("#plan_2").addClass("purchased");

        }
        if (plan_id == 3) {
          $("#plan_3").addClass("purchased");

        }
        document.getElementById("ios_checkbox").disabled = false;
        $("#payment_div").hide();
      }
      if (shopify_freemium != 0) {
        document.getElementById("ios_checkbox").disabled = false;
        $("#payment_div").hide();
      }
      ...
      document.querySelectorAll('.card.card_custom_class.text-center').forEach((e) => {
          
        if (e.classList.contains('purchased')) {
        
          e.style.border = "6px solid #ff4500";
          console.log(e.children[0].children[1].children);
        //   e.children[0].children[3].setAttribute('style', 'background : green ;');
          e.children[0].children[3].children[0].innerText = "Active Plan";

          //e.children[0].children[1].children[0].setAttribute('style', 'background-color: green ;');
        //   e.children[0].children[1].setAttribute('style', 'background-color: green ;');
        }
  ...
  <script>
    ...
    $(document).on('click', '.editbtn', function() {
      ...
      var editPixelId = $(this).attr('value');
      $.ajax({
        type: 'get',
        url: 'editPixel',
        data: {
        ...
        success: function(response) {
          ...
          $('#save1').val('update');
          $('#updatedId').val(response['id']);
          $('#pixels_id').val(response['pixel_id']);

          if (response['access_token']) {
            $('#ios_checkbox').attr('checked', true);

            ios_checkBox();
            $('#aceess_token').val(response['access_token']);
            $('#test_token').val(response['test_token']);

          }
          if (response['type'] == 'niche') {
            $('#flexRadioDefault3').attr('checked', true);
            niche();
            removeFirstChar = response['tag'].slice(4);

            $('#fieldvalue3').val(removeFirstChar);
          ...
          if (response['type'] == 'collection') {
            ...
            collection();
            let string = response['collection']
            var options = JSON.parse("" + string + "");
            $("#collectionSelector option").each(function(indexx, item) {
              var vall = $(this).val();
              options.forEach(function(item2, index) {
                var coll = item2;
            ...
            $("#collectionSelector").trigger("chosen:updated");
          }
        }
      });
    });
    ...
    function myFunction() {
      ...
      var colection, tag, updateId, pixel_prefix;

      var id = document.getElementById('pixels_id').value;
      var aceess_token = document.getElementById('aceess_token');
      var test_token = document.getElementById('test_token');
      var mode = document.getElementById('save1').value;
      ...
      if (id == "" || id == null) {
        iziToast.error({
          title: 'OK',
          message: 'Please Insert Pixel Id !',
          position: "topRight"
        });
        return false;
      }

      element = document.getElementById('fieldvalue3');

      element1 = document.getElementById('collectionSelector');
      updated = document.getElementById('updatedId');

      pixel_prefix = "fox_";
      if (element1 != null) {
        colection = $('#collectionSelector').val();
      } else {
        colection = null;
      }
      if (element != null) {
      ...
      if (updated != null) {
        updateId = updated.value;
      } else {
        updateId = null;
      }
      if (aceess_token != null) {
        aceess_token = aceess_token.value;
      } else {
        aceess_token = null;
      }
      if (test_token != null) {
        test_token = test_token.value;
      } else {
        test_token = null;
      }
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.error) {
            ...
            iziToast.success({
              title: 'OK',
              message: 'Pixel has been created Successfully!',
              position: "topRight"
            });
            getPixel();
  ...
  <script>
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (let item of data) {
            let editid = item.id
            let pixelid = item.pixel_id
            let pixeltype = item.type
            let tag = item.tag
            let collection = item.collection
            let aces = item.access_token
            ...
            if (pixeltype == 'collection') {
              pixeltype = collection;
            }
            if (itemStatus == 1) {

              sta = '<input type="checkbox" class="statusChange"  value="' + editid + '"   id="status_pixel" checked >';
            } else {

              sta = ' <input type="checkbox" class="statusChange"     value="' + editid + '"   id="status_pixel">';
            }
            if (aces) {
              aces = '<i class="bi bi-check-circle-fill icon_check"></i>'
            } else {
              aces = '<i class="bi bi-x-circle-fill icon_cross"></i>'
            }
            ...
            pixelData += `<tr>
                            ...
                            <td class="d-flex">
                                ...
                                <a href="#">
                                    ...
                                    <i class="bi bi-pencil-square action_icon editbtn" value=${editid}"></i>
                                </a>
                                <a class="delpixel" data-id="${editid}">
                                    <i class="bi bi-trash action_icon" data-id="${editid}"></i>
                                </a>
                                <a href="#">
                                    <label class="switch">
                                          ${sta}
    ...
    $(document).on('click', '#status_pixel', function() {
      ...
      $.ajax({
        ...
        if(response.status == 'false')
          {
            document.getElementById('status_pixel').checked = false;
          }
    ...
    $(document).on('click', '.send_button_pixel_contact', function() {
      ...
      $('#conatct_form')[0].reset();
    });


    $('body').on('click', '.delpixel', function() {
      let div = $(this)
  ...
  <script>
      ...
      $.get("{{ url('catalog') }}")
        .done(function(data) {
          ...
          for (let item of data) {
            ...
            let collection = item.collection_handle
            let shop = "{{ Auth::user()->name }}"
            let domain = "{{ url(" / ") }}"
            if (item.variants == 1) {
              variant = '1'
            } else {
            ...
            let url = `https://app.pixelsfox.com/{{auth()->user()->name}}/pages/pixels-fox-feed?collection=${collection}&variant=${variant}&category=${category}`
            if (variant) {
              variant = "Yes"
            } else {
              variant = "NO"
            ...
            html1 += `<tr>
                         <td scope="row">${feedName} </td>
                            <td>${collection}</td>
                            <td>${variant}</td>
                            <td><span class="generate" id="generate" data-url="${url}">Click To Copy URL</span> <p class="generateurl" style="display:none">${url}</p></td>
                            <td class="d-flex">
                                <a class="delc" data-id="${id}">
                                    <i class="bi bi-trash action_icon"></i>
                                </a>
    ...
    $('body').on('click', '#save_feed', function() {



      let feedName = $('#feedName').val()
      let variants = $('.variants:checked').val()
      let category = $('#category').val()
      let collection = $('#collection1').val()
      let ptype = $('#ptype').val()
      let ctype = $('#custom_type').val()




      if (feedName == "" || feedName == null) {
        iziToast.error({
          title: 'OK',
          message: 'Please add feed name!',
          position: "topRight"
        });
        return false;
      }
      ...
      if (update == "update") {
        var mode = "update"
        updateId = $('#update').attr('data-id')
      }

      $.post("{{ url('savecatalog') }}", {
          feedName: feedName,
          variants: variants,
          category: category,
        ...
        .done(function(data) {
          ...
          iziToast.success({
            title: 'OK',
            message: 'Catalog has been created Successfully!',
            position: "topRight"
          });
          $('#create_catalogue_modal').modal('hide')
          $('#myForm')[0].reset();
          getCatalog()
        })
    })
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#interest").addClass('btn btn-danger');
      $('#table_id').DataTable({
        "order": [
          [0, "desc"]
        ],
    ...
    function htmlToCSV(html, filename) {
      var data = [];
      var rows = document.querySelectorAll("#tableInterset tr");
      // console.log(rows);
    ...
    if (localStorage.getItem('type')) {
      let adtype = localStorage.getItem('type')
      $('.tag').removeClass('selected')
      $(`.tag[data-type="${adtype}"]`).addClass('selected')
    }
    ...
    $(document).on('click', '.tag', function() {
      ...
      $('.tag').removeClass('selected')
      $('.tag').removeClass('btn btn-danger')
      ...
      // {
      //     type = $(this).attr('data-type').replace('data',capitalizeFirstLetter($('#search').val()));
      // }

      search($('#search').val(), type)
    })

    $(document).on('change', '.copyname', function() {
      let names = $('.copyname:checked')
      // console.log(names)
    })
    ...
    $(document).on('click', '.suggest', function(e) {
      let box = $(this)
      // console.log(box)
      if ($(box).hasClass('suggest')) {
        if ($(box).parent().find('input:checkbox').prop("checked")) {
          $(box).parent().find('input:checkbox').prop('checked', false);
        } else {
          $(box).parent().find('input:checkbox').prop('checked', true);
        }
      }
    ...
    $(document).on('click', '#saveCopy', function() {
      ...
      for (let name of names) {
        // console.log($(name))
        // console.log()
        // console.log($(name).parent().find('td'))
        arr.push($(name).parent().parent().find('.suggest').text())
      }
    ...
    function search(text, type = null) {
      if (text.length >= 3) {
        $('#tableInterset tbody').html(`<tr><td align="center "><div style="color: #ff4500" class="spinner-border" role="status">
  <span class="sr-only"></span>
        ...
        type = $('.tag.selected').attr('data-type')

        if ($('.tag.selected').hasClass('interest')) {
          type = $('.tag.selected').attr('data-type').replace('data', capitalizeFirstLetter($('#search').val()));
        }
        ...
        $.get("{{ url('facebook/interest') }}", params)
          .done(function(data) {
            $('.spinner-border').hide();
            console.log(data)
            let res = data.data
            $('#tableInterset tbody').html('')
            $('#tableHeader thead').html('')
            let columns = {
              name: true,
              audience_size: false,
              path: false,
            ...
            for (let row of res) {
              let temp = []
              let tr = `<tr>
                     <td><input type='checkbox' class='copyname' /></td>
                    <td class="suggest name">${row.name}</td>`
              data.push('')
              temp.push(row.name)
              if (row.hasOwnProperty('audience_size_upper_bound')) {
                tr += `<td class="audience_size">${row.audience_size_upper_bound ? numFormatter(row.audience_size_upper_bound):""}</td>`
                temp.push(row.audience_size_upper_bound)
              }
              if (row.hasOwnProperty('path')) {
                tr += `<td class="path">${row.path  ? row.path.toString():""}</td>`
              }

              if (row.hasOwnProperty('topic')) {
                tr += `<td class="topic">${row.topic ? row.topic:""}</td>`;
                temp.push(row.topic)
              }

              if (row.hasOwnProperty('coverage')) {
                tr += `<td class="coverage">${row.coverage ? row.coverage:""}</td>`
                temp.push(row.coverage)
              }

              // if(row.hasOwnProperty('description'))
              // {
              //     tr += `<td class="description">${row.description ? row.description:""}</td>`
              //     temp.push(row.description)
              // }
              ...
              if (row.hasOwnProperty('audience_size_upper_bound')) {
                if (!columns.audience_size) {
                  columns.audience_size = true
                }
              }
              if (row.hasOwnProperty('path')) {
                if (!columns.path) {
            ...
            if (columns.name) {
              ...
              th += `<th data-id="${id}">Name</th>`
              btns += `<button type="button" data-type="${id}" class="btn btn-secondary filter-btn">Name</button>`
            }

            if (columns.audience_size) {
              id = 'audience_size'
              th += `<th data-id="${id}">Audience Size</th>`
              btns += `<button type="button" data-type="${id}" class="btn btn-secondary filter-btn">Audience Size</button>`
            }

            if (columns.path) {
              id = 'path'
              th += `<th data-id="${id}">Path</th>`
              btns += `<button type="button" data-type="${id}" class="btn btn-secondary filter-btn">Path</button>`
            }

            if (columns.topic) {
              id = 'topic'
              th += `<th data-id="${id}">Category</th>`
              btns += `<button type="button" data-type="${id}" class="btn btn-secondary filter-btn">Category</button>`
            }

            if (columns.coverage) {
              id = 'coverage'
              th += `<th data-id="${id}">Coverage</th>`
              btns += `<button type="button" data-type="${id}" class="btn btn-secondary filter-btn">Coverage</button>`
            }

            // if(columns.description)
            // {
            //     id = 'description'
            //     th += `<th data-id="${id}">Description</th>`
            //     btns += `<button type="button" data-type="${id}" class="btn btn-secondary filter-btn">Description</button>`
            // }

            $('#tableHeader').html(th)
            $('#filter').html(btns)

            $('#tableInterset tbody').append(table)

            // Table headers Filter on click 
...
Vehicles & Parts > Vehicles > Watercraft > Yachts`;
 ...
 <!-- Messenger Chat Plugin Code -->
    ...
    <!--  chatbox.setAttribute("page_id", "102005175681567");-->
