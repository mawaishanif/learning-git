...
return [
    ...
    */
    ...
    'webhooks' => [
		...
		[
        'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'themes/publish'),
        'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://app.pixelsfox.com/webhook/themes-publish')
		],
// 		[
//         'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'orders/create'),
//         'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', 'https://app.pixelsfox.com/webhook/order-create')
// 		],
    ],
